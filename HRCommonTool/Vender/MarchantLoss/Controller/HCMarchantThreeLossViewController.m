//
//  HCMarchantThreeLossViewController.m
//  HczyJtb
//
...
@interface HCMarchantThreeLossViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation HCMarchantThreeLossViewController
            ...
            if ([finishResult[@"status"] integerValue] == 1) {
                ...
                if ([[HRNetworkTool shareTool] isCheckData:dataDic]) {
                    ...
                    if ([[HRNetworkTool shareTool] isCheckData:dataArr]) {
                        ...
                        if (dataArr.count == pre_page) {
                            weakSelf.hasMoreDataFlag = YES;
                        }else{
                            weakSelf.hasMoreDataFlag = NO;
                        }
                        dispatch_async(dispatch_get_main_queue(), ^{
