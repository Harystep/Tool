...
#import "WHSPhotoImageView.h"
#import <MobileCoreServices/MobileCoreServices.h>
#import <AVFoundation/AVFoundation.h>
#import <Photos/Photos.h>
#import <AssetsLibrary/AssetsLibrary.h>

@interface WHSPhotoImageView()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate>
@property(nonatomic,strong)UINavigationController *navigation;
@property(nonatomic,strong) UIView *viewbg;
@property(nonatomic,strong)UIViewController *viewImageController;
@property (nonatomic, strong) UIImage *iconImage;
@end
@implementation WHSPhotoImageView
+(WHSPhotoImageView *)shareImageView{
    
    static WHSPhotoImageView *imageview = nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{

        imageview = [[WHSPhotoImageView alloc]init];
    });
    return imageview;
}
