...
- (UIButton *)playOrPauseBtn {
    ...
    if (!_playOrPauseBtn) {
        ...
        [_playOrPauseBtn setBackgroundImage:[UIImage imageNamed:@"video_icon_play"] forState:UIControlStateNormal];//ImageResources.bundle/play
        [_playOrPauseBtn setBackgroundImage:[UIImage imageNamed:@"video_icon_stop"] forState:UIControlStateSelected];//ImageResources.bundle/pause
