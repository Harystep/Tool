...
//    CGFloat number = 1;
//    switch (type) {
//        case HBChartsNumericalTransformationWanYuanType: {
//            number = 10000.0f;
//        }
//            break;
//        case HBChartsNumericalTransformationYiYuanType: {
//            number = 100000000.0f;
//        }
//            break;
//
...
//    NSString *num = [NSString stringWithFormat:@"%.0f",number];
//    if (num.length >= 5 && num.length < 9) {
//        return HBChartsNumericalTransformationWanYuanType;
//    }  else if (num.length >= 9) {
//        return HBChartsNumericalTransformationYiYuanType;
//    } else return HBChartsNumericalTransformationDefaultType;
//}
